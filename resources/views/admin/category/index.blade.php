          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Add Property Type</h5>
              </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8 ">
                      <div class="form-group">
                        ...
                        <input type="text"  class="form-control" placeholder="Property Type" style="border:2px solid #e14eca; background-color:transparent;" name="property_type" >
                      </div>
                    </div>
                  </div>
                  <div class="row">
